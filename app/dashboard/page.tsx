          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="ml-4 px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white"
              >
                Sign Out
              </button>
            </div>
          ...
          <div className="mb-6">
            ...
            {accounts && accounts.length > 0 ? (
                ...
                {accounts.map((account) => (
                  ...
                  >
                    <div className="px-4 py-5 sm:p-6">
                      ...
                      <dd className="mt-1 text-sm text-gray-500 dark:text-gray-300">Account: ****{account.accountNumber.slice(-4)}</dd>
              ...
              <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-lg shadow">
                <p className="text-gray-500 dark:text-gray-300 mb-4">You don&apos;t have any accounts yet.</p>
              </div>
            )}
